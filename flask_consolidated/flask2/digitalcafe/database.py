...
users = {
    "chums@example.com": {"password": "1",
                          "first_name": "Matthew",
                          "last_name": "Uy"},
    "joben@example.com": {"password": "2",
                          "first_name": "Joben",
                          "last_name": "Ilagan"},
    "bong@example.com": {"password": "3",
                         "first_name": "Bong",
                         "last_name": "Olpoc"},
    "joaqs@example.com": {"password": "4",
                          "first_name": "Joaqs",
                          "last_name": "Gonzales"},
    "gihoe@example.com": {"password": "5",
                          "first_name": "Gio",
                          "last_name": "Hernandez"},
    "vic@example.com": {"password": "6",
                        "first_name": "Vic",
                        "last_name": "Reventar"},
    "joe@example.com": {"password": "7",
                        "first_name": "Joe",
                        "last_name": "Ilagan"},
}
